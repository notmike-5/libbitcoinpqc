#include <stdlib.h>
#include <string.h>
#include "libbitcoinpqc/falcon.h"

/*
 * This file integrates the reference implementation of FALCON-512
...
int falcon512_keygen(
    ...
    int result = falcon_keygen_make(&rng, (void (*)(void *, size_t, uint8_t *, size_t))shake256_extract,
                               FALCON_LOGN_512, sk, FALCON512_SECRET_KEY_SIZE,
                               pk, FALCON512_PUBLIC_KEY_SIZE, tmp, FALCON_TMPSIZE_KEYGEN(9));
